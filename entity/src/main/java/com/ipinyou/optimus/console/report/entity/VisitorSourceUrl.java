 ...
 */
@Entity
@Table(name = "rpt_visitor_source_url")
@Data
@ToString(callSuper = true)
public class VisitorSourceUrl implements com.ipinyou.base.entity.Entity {

	private static final long serialVersionUID = 8339002663154609408L;
