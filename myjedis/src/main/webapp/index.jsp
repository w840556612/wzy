...
<body>  
    ...
    <form name="userForm1" action="/mj/upload" enctype="multipart/form-data" method="post">  
        <div id="newUpload1">  
    ...
    <form name="userForm2" action="/mj/upload2" enctype="multipart/form-data" method="post"">  
        <div id="newUpload2">  
            <input type="file" name="file">  
    ...
    <br>  
     <h1>springMVC传文件</h1>   
    <form name="userForm2" action="/mj/fileUpload" enctype="multipart/form-data" method="post">  
        <div id="newUpload2">  
            <input type="file" name="hhh" id="hhh8"> 
            <input type="text" name="aa" id="aa" value="99"> 
        </div>  
        <input type="button" id="btn_add2" value="增加一行" >  
    ...
    <form name="userForm3" action="/mj/stest" enctype="multipart/form-data" method="post">  
            <input type="text" name="aa" id="aa" value="99"> 
        <input type="button" id="btn_add2" value="增加一行" >  
        
        <input type="submit" value="tiaojiao" >  
